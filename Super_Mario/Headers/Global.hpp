...
constexpr float MARIO_ACCELERATION = 0.15f;
constexpr float MARIO_JUMP_SPEED = -4 - GRAVITY;
constexpr float BLOCK_SHAKE_SPEED = -2;
...
constexpr float TRAMPOLINE_CHARGE_SPEED = 2;
constexpr unsigned char CELL_SIZE = 16;
constexpr float CANNON_POWER = 8;
...
constexpr unsigned short DEATHORB_TURN_ON_ANIMATION_SPEED = 4;
constexpr unsigned short DEATHORB_TWILIGHT_ANIMATION_SPEED = 7;
...
enum DeathCause {
	instant_death, normal_death, sliding_koopa, projectile
};
